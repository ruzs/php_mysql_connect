...
<form action="./api/add_news.php" method="POST">
   <div class="form-group row">
        ...
        <input type="text" class="form-control col-md-8" name="subject">
   </div> 
   <div class="form-group row">
        <label class="col-form-label col-md-2 text-right">內容</label>
        <textarea class="form-control col-md-8" name="content" style="height:200px"></textarea>
   </div> 
   <div class="form-group row">
        <label class="col-form-label col-md-2 text-right">類別</label>
        <input type="text" class="form-control col-md-8" name="type" >
   </div>
   <div class="text-right text-secondary col-md-11">現在時間:<?=date("Y-m-d H:i:s");?></div>
